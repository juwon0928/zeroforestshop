# Generated by Django 3.1.5 on 2021-10-18 07:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(blank=True, choices=[('P', 'primary'), ('N', '')], max_length=1)),
                ('slug', models.SlugField()),
                ('image', models.ImageField(upload_to='')),
                ('description', models.TextField(default='')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='category_items', to='core.category')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
